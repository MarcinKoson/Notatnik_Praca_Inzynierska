...
import com.thesis.note.databinding.ActivityOldMainBinding
import com.thesis.note.recycler_view_adapters.NoteListAdapter

import kotlinx.coroutines.GlobalScope
import kotlinx.coroutines.launch

@Deprecated ("old list of notes")
class OldMainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener ,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityOldMainBinding.inflate(layoutInflater) //LAYOUT BINDING CLASS
